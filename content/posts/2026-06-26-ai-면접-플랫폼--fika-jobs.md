---
title: "Fika Jobs 리뷰: AI 면접 에이전트가 바꾸는 영상 기반 채용의 미래"
date: 2026-06-26
draft: false
tags: ["AI 면접 플랫폼", "Fika Jobs", "채용 AI", "영상 면접", "HR 테크"]
categories: ["ai-news"]
description: "스웨덴 스타트업 Fika Jobs가 400만 달러 투자를 유치하며 주목받고 있다. AI 에이전트가 직접 면접을 진행하고 결과를 짧은 영상 프로필로 자동 변환하는 새로운 채용 플랫폼의 핵심 기능과 한계를 분석한다."
cover:
  image: "images/ai-면접-플랫폼--fika-jobs-cover.jpg"
  alt: "Fika Jobs 리뷰: AI 면접 에이전트가 바꾸는 영상 기반 채용의 미래 커버 이미지"
  caption: "Photo by [chunleizhao](https://pixabay.com/ko/photos/%EC%B2%A0%EB%8F%84-%EA%B8%B0%EC%B0%A8-%ED%94%8C%EB%9E%AB%ED%8F%BC-%EC%B2%A0%EB%8F%84-%ED%94%8C%EB%9E%AB%ED%8F%BC-6858240/) on Pixabay"
---

> ※ 이 글에는 제휴 마케팅 링크가 포함될 수 있으며, 구매 시 수수료를 받을 수 있습니다.

## AI가 직접 면접을 본다 — 채용의 판이 바뀌고 있다
...
![Fika Jobs의 10% 수수료는 전통 헤드헌팅(20~30%) 대비 절반 이하지만, 고연봉 포지션일수록 절대 금액 부담은 커진다](/ai-tools-blog/images/ai-면접-플랫폼--fika-jobs-diagram.png)
...
| 사용자 유형 | 비용 | 출처 |
|------------|------|------|
| 구직자 | **무료** | [techcrunch.com](https://techcrunch.com/2026/06/23/fika-jobs-raises-4m-to-build-a-video-first-hiring-platform-where-ai-agents-interview-candidates/) |
| 고용주 — 채용 전 | **선불 없음** (성공보수 모델) | [techcrunch.com](https://techcrunch.com/2026/06/23/fika-jobs-raises-4m-to-build-a-video-first-hiring-platform-where-ai-agents-interview-candidates/) |
| 고용주 — 채용 성공 시 | 입사자 **첫 해 연봉의 10%** | [techcrunch.com](https://techcrunch.com/2026/06/23/fika-jobs-raises-4m-to-build-a-video-first-hiring-platform-where-ai-agents-interview-candidates/) |

구직자는 완전 무료로 플랫폼을 이용할 수 있으며, 고용주는 채용에 성공했을 때만 비용이 발생한다. 이는 전통적인 채용 플랫폼의 구인공고 게재비나 월정액 구독 모델과 다른, 성과 연동형 과금 방식이다. 전통적인 헤드헌터 수수료는 통상 첫 해 연봉의 **20~30%** 수준으로 알려져 있어, Fika의 **10%** ([techcrunch.com](https://techcrunch.com/2026/06/23/fika-jobs-raises-4m-to-build-a-video-first-hiring-platform-where-ai-agents-interview-candidates/)) 수수료는 상대적으로 경쟁력 있는 수준이다.

---

## 유사 서비스 비교표

| 항목 | Fika Jobs | LinkedIn | 전통 헤드헌팅 |
|------|-----------|----------|--------------|
| 면접 주체 | AI 에이전트 | 없음 | 인간 리크루터 |
| 프로필 형식 | 영상 클립 | 텍스트/사진 | 이력서 |
| 구직자 비용 | 무료 | 무료/프리미엄 | 무료 |
| 고용주 비용 | 채용 성공 시 10% | 구인공고 과금 | 채용 성공 시 20~30% |
| 편향 감소 기능 | 메타데이터 익명화 | 없음 | 없음 |
| 지속형 프로필 | 있음 (라이브 프로필) | 있음 | 없음 |
| Per-job 지원 불필요 | 있음 | 없음 | 없음 |
| AI 개인화 질문 | 있음 | 없음 | 없음 |
| 서비스 지역 | 스웨덴 우선 (현재) | 글로벌 | 글로벌 |
| 공개 런칭 시점 | 2026년 가을 (예정) | 운영 중 | 운영 중 |
...
-(https://tech.eu/2026/06/23/fika-jobs-raises-4m-for-ai-powered-video-resumes/)
-(https://www.swedishtechnews.com/fika-jobs-launches-video-first-hiring-platform-backed-with-4m-in-pre-seed-funding/)